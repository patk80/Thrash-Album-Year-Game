...
let missedAlbumsHeading = document.querySelector("#missed-albums-heading")
...
const randomAlbum = () => {
    ...
    if(albumsArray.length === 0) {
        ...
        albumTextContent.style.display    = "none";
        missedAlbumsHeading.textContent   = "You missed these albums:";
